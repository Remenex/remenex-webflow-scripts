...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Remenex/remenex-webflow-scripts@1.0.3/marquee/remenex-marquee.css">
```
...
```html
<script src="https://cdn.jsdelivr.net/gh/Remenex/remenex-webflow-scripts@1.0.3/marquee/remenex-marquee.js"></script>
```
